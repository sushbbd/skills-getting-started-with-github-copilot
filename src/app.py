...
activities = {
    ...
    "Track and Field": {
        "description": "Running, jumping, and throwing events for competitive athletes",
    ...
    "Science Olympiad": {
        "description": "Compete in science competitions and solve challenging problems",
